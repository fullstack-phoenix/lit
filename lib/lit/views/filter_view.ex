defmodule Lit.FilterView do
  ...
  import Lit.I18n, only: [message: 1]
  ...
  ## Example
      ...
      "<select class=\\"focus:border-blue-400 focus:ring-2 focus:ring-blue-200 focus:outline-none w-full text-base placeholder-gray-400 border border-gray-300 rounded py-1.5 px-3\\" id=\\"filters_\\" name=\\"filters[]\\"><option value=\\"post[title_contains]\\" selected>Contains</option><option value=\\"post[title_equals]\\">Equals</option></select>"
  """
  ...
  def filter_select(prefix, field, params) do
    ...
    select(:filters, "", opts, class: "focus:border-blue-400 focus:ring-2 focus:ring-blue-200 focus:outline-none w-full text-base placeholder-gray-400 border border-gray-300 rounded py-1.5 px-3", value: "#{prefix}[#{selected}]")
  end
  ...
  def filter_number_input(prefix, field, params) do
    ...
    text_input(prefix, String.to_atom(name), value: value, type: "number", class: "focus:border-blue-400 focus:ring-2 focus:ring-blue-200 focus:outline-none w-full text-base placeholder-gray-400 border border-gray-300 rounded py-1.5 px-3")
  end
  ...
  def filter_string_input(prefix, field, params) do
    ...
    text_input(prefix, String.to_atom(name), value: value, class: "focus:border-blue-400 focus:ring-2 focus:ring-blue-200 focus:outline-none w-full text-base placeholder-gray-400 border border-gray-300 rounded py-1.5 px-3")
  end
  ...
  def filter_boolean_input(prefix, field, params) do
    ...
    checkbox(prefix, :"#{field}_equals", value: value, class: "form-checkbox")
  end
